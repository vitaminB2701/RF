...
Par.energyfile = fullfile('Energy','LH2.txt'); % File containing ID, site E,...
Par.pdbfile = {fullfile('pdb','1kzu_full_original.pdb'),'ABCDEGH'}; % File containing pdb name and specify chains
