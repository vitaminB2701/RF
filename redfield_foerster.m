...
for iter = 1:Niter
    ...
    for bl = 1:BlockSize
        ...
        [Ad(:,bl),Ae,Fe,mux] = feval(fun_linear_spectra,E,U,Da,Di);
        Aed(:,:,bl) = Ae;
        Fed(:,:,bl) = Fe;
        ...
        [P1,P2,TA1d(:,:,:,bl),TA2d(:,:,:,bl),TF1d(:,:,:,bl),TF2d(:,:,:,bl)]...
            = solve_kin_model(X,Xexc,t,K,Ae,Fe,pol_par,pol_per);        
        Pd(:,:,:,bl) = P1+2*P2;
